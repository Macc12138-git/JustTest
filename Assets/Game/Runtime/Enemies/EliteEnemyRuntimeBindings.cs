...
namespace JustTest.Game.Enemies
{
    ...
    public sealed class EliteEnemyRuntimeBindings : CombatEnemyRuntime2D
    {
        [SerializeField] private EliteEnemyController2D controller;
        ...
        internal EliteEnemyController2D Controller => controller;
        ...
        private void Awake()
        {
            ...
            Debug.LogError($"{nameof(EliteEnemyRuntimeBindings)} is missing an Inspector reference.", this);
            enabled = false;
        }
        ...
        private void OnControllerDefeated(EliteEnemyController2D defeatedController)
        {
