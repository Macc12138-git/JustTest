...
namespace JustTest.Game.Enemies
{
    ...
    public sealed class RangedEnemyRuntimeBindings : CombatEnemyRuntime2D
    {
        [SerializeField] private RangedEnemyController2D controller;
        ...
        private void Awake()
        {
            ...
            Debug.LogError($"{nameof(RangedEnemyRuntimeBindings)} is missing an Inspector reference.", this);
            enabled = false;
        }
        ...
        private void OnControllerDefeated(RangedEnemyController2D defeatedController)
        {
